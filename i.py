...
class APIKeyManager:
    def __init__(self, api_dir="apikey/api/key"):
        ...
        self.api_folders = [
            ...
            "ig", "spamdiskonen", "nhaymess", "treomess", "docquyen", "regtokenn", "thueregg", "spamv6", "spamv5", "uuid"
        ]
    ...
    def list_uuid_entries(self):
        ...
        if entries:
            for i, entry in enumerate(entries, 1):
                ...
                print(Colorate.Horizontal(Colors.cyan_to_blue, f"      Device ID: {entry.get('device_id', 'N/A')}", 1))
                print(Colorate.Horizontal(Colors.cyan_to_blue, f"      Product ID: {entry.get('product_id', 'N/A')}", 1))
        else:
...
║                    📋 UUID MANAGER MENU 📋                  ║
╠══════════════════════════════════════════════════════════════╣
║ 1️⃣   Thêm UUID entry mới                                     ║
║ 2️⃣   Xem danh sách UUID entries                              ║
║ 3️⃣   Xóa UUID entry                                          ║
║ 4️⃣   Quay lại menu chính                                     ║
╚══════════════════════════════════════════════════════════════╝
            """
